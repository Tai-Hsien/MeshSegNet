...
class MeshSegNet(nn.Module):
    ...
    def forward(self, x, a_s, a_l):
        ...
        x = F.relu(self.glm1_bn1_1(self.glm1_conv1(x_ftm)))        
        glm_1_sap = F.relu(self.glm1_bn1_2(self.glm1_conv1(sap)))
        ...
        x = F.relu(self.glm2_bn1_1(self.glm2_conv1(x_mlp2)))
        glm_2_sap_1 = F.relu(self.glm2_bn1_2(self.glm2_conv1(sap_1)))
        glm_2_sap_2 = F.relu(self.glm2_bn1_3(self.glm2_conv1(sap_2)))
